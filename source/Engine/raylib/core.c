...
#include "rlgl.h"               // raylib OpenGL abstraction layer to OpenGL 1.1, 3.3+ or ES2
    ...
    #include "rgif.h"  // Support GIF recording
#endif
...
#include <sys/stat.h>           // Required for: stat() [Used in GetFileModTime()]
    ...
    #include <glfw/include/GLFW/glfw3.h>         // GLFW3 library: Windows, OpenGL context and Input management
                                    // NOTE: GLFW3 already includes gl.h (OpenGL) headers

    // Support retrieving native window handlers
    #if defined(_WIN32)
        #define GLFW_EXPOSE_NATIVE_WIN32
        #include <glfw/include/GLFW/glfw3native.h>       // WARNING: It requires customization to avoid windows.h inclusion!
        ...
        #include <glfw/include/GLFW/glfw3native.h>   // Required for: glfwGetX11Window()
    #elif defined(__APPLE__)
        #include <unistd.h>             // Required for: usleep()

        //#define GLFW_EXPOSE_NATIVE_COCOA      // WARNING: Fails due to type redefinition
        #include <glfw/include/GLFW/glfw3native.h>   // Required for: glfwGetCocoaWindow()
    #endif
#endif
